...
```{r 7-spatial_distribution_changes_magnitude, fig.height=4.5, fig.cap='Fig. 7. Cambios en la cantidad de precipitación anual. Celdas marcadas con "X" indican tendencias no significativas.'}
...
```{r 8-spatial_distribution_changes_season, fig.height=4.5, fig.cap='Fig. 8. Cambios en las fechas de inicio y fin de la temporada lluviosa. Celdas marcadas con "X" indican tendencias no significativas.'}
