...
```{r 1-mean_temporal_dist, fig.height=3, fig.width=6, fig.cap='Fig. 1. Distribución temporal de la precipitación (mm/semana).'}
...
```{r 2-spatial_distribution_mean_annual, fig.height=4.5, fig.cap='Fig. 2. Distribución espacial de la precipitación media anual.'}
...
```{r 3-spatial_distribution_seasonality, fig.height=5, fig.cap='Fig. 3. Distribución espacial del inicio y término de la temporada lluviosa.'}
...
```{r 4-density_mean_annual, fig.height=3, fig.width=6, fig.cap='Fig. 4. Frecuencia de la precipitación media anual.'}
...
```{r 5-spatial_distribution_variability, fig.height=4.5, fig.cap='Fig. 5. Distribución espacial de la variabilidad interanual de la precipitación.'}
...
```{r 6-ggridges_annual, fig.height=8, fig.width=4, out.width='40%', fig.cap='Fig. 6. Anomalías en la precipitación anual'}
...
```{r 7-spatial_distribution_changes_magnitude, fig.height=4.5, fig.cap='Fig. 7. Cambios en la cantidad de precipitación anual. Celdas marcadas con "X" indican tendencias no dignificativas.'}
...
```{r 8-spatial_distribution_changes_season, fig.height=4.5, fig.cap='Fig. 8. Cambios en las fechas de inicio y fin de la temporada lluviosa. Celdas marcadas con "X" indican tendencias no dignificativas.'}
...
```{r 9-spatial_distribution_changess_variability, fig.height=4.5, fig.cap='Fig. 9. Cambios en variabilidad interanual. Celdas marcadas con "X" indican tendencias no significativas.'}
